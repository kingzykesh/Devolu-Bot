  ...
  return (
    <div className="w-full px-5 md:px-8">
      <div className="rounded-[8px] bg-[#102A40] p-4 mb-5">
        <h4 className="text-white font-[800] text-[16px] text-center">BOTS</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px]">
          ...
          <div className="border-[2px] rounded-[8px] border-[#3D4D5B] px-[16px] py-[10px] flex gap-[4px] items-center justify-between bg-[#0C2132]">
            ...
            <Link to="/bot-details" className="bg-[#1E77B8] py-[7px] px-[14px] font-[700] rounded-[8px] text-white">Learn More</Link>
          </div>
